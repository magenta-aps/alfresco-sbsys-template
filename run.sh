...
#JAVA_HOME="/opt/jdk8u181-b13" MAVEN_OPTS="-Xms256m -Xmx2G -javaagent:/home/andreas/downloads/hotswap-agent.jar -XXaltjvm=dcevm" mvn clean install alfresco:run
...
#JAVA_HOME="/opt/jdk8u181-b13" MAVEN_OPTS="-Xms256m -Xmx2G" mvn clean install alfresco:run
